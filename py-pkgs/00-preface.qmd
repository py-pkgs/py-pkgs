# Preface {#sec-00-preface .unnumbered .unlisted}
...
**Chapter 1: [Introduction](#sec-01-introduction)** first gives a brief introduction to packages in Python and why you should know how to make them.

**Chapter 2: [System setup](#sec-02-system-setup)** describes how to set up your development environment to develop packages and follow the examples in this book.

In **Chapter 3: [The Whole Game: How to Package a Python](#sec-03-how-to-package-a-python)**, we develop an example package from beginning-to-end as a practical demonstration of the key steps involved in the packaging process. This chapter forms the foundation of the book and will act as a reference sheet for readers creating packages in the future.
...
- **Chapter 4: [Package structure and distribution](#sec-04-package-structure-and-distribution)** 
- **Chapter 5: [Testing](#sec-05-testing)**
- **Chapter 6: [Documentation](#sec-06-documentation)**
- **Chapter 7: [Releasing and versioning](#sec-07-releasing-and-versioning)**
- **Chapter 8: [Continuous integration and deployment](#sec-08-continuous-integration-and-deployment)**

## Assumptions

While this book aims to introduce Python packaging at a beginner level, we assume readers have basic familiarity with the concepts listed in @tbl-00-assumptions:
...
: Concepts this book assumes readers have basic familiarity with. {#tbl-00-assumptions}
