...
| (Optional) Basic familiarity with version control\index{version control} and Git\index{Git} and GitHub\index{GitHub} (or similar tools) | [*Happy Git and GitHub for the useR*](https://happygitwithr.com)  [@bryan2021] or [*Research Software Engineering with Python*](https://merely-useful.tech/py-rse/git-cmdline.html)  [@rsep2021]| 
