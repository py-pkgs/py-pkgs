...
While this book aims to introduce Python packaging at a beginner level, we assume readers have basic familiarity with the following key skills/tools:

| Item    | Learning resources |
| :--- | ---: |
| How to import Python packages with the `import` statement | Python [documentation](https://docs.python.org/3/reference/simple_stmts.html#the-import-statement) | {-}| How to use and write simple Python functions| [Plotting and Programming in Python: Writing Functions](https://swcarpentry.github.io/python-novice-gapminder/16-writing-functions/index.html) {cite:p}`carpentries2021` |
