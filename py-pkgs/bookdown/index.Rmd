...
| How to write conditionals (`if`/`elif`/`else`) and loops (`for`) in Python| Python documentation|
| How to use and write simple Python functions| *Plotting and Programming in Python: Writing Functions*  [@carpentries2021] |
