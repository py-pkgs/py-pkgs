...
> Note 2: yuo may see many red warnings, these can be ignored and are meerely suggestions on how to improve your docs if you wish.
...
def catbind(a, b):
    ...
    Examples
    --------
    >>> from foocat.foocat import catbind
    >>> a = pd.Categorical(["character", "hits", "your", "eyeballs"])
    >>> b = pd.Categorical(["but", "integer", "where it", "counts"])
    >>> catbind(a, b)
    [character, hits, your, eyeballs, but, integer, where it, counts]
