...
### Reading and rendering the docs locally
...
### Reading and rendering the docs remotely
...
Python packages are generally shared via the [PyPI package Index](https://pypi.org/). However, when we are just starting to develop packages, and/or at the development stage of our pacakge, we typically first check that everything works by submitting to [testPyPi](https://test.pypi.org/).