...
You'll be able to follow along with the examples presented in this book regardless of what IDE you choose, but we recommend either PyCharm (see [Section 1.3.1](#pycharm-setup) for details on setting up PyCharm) or RStudio (see [Section 1.3.3](#rstudio-python-setup)).
...
<img src="img/set-up-pycharm1.png" width=600>
...
<img src="img/set-up-pycharm2.png" width=600>
