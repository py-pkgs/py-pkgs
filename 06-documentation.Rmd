...
> Note the use of --dev to specify a development dependency, i.e., a package that is not required by a user to use you package, but is required for development purposes.
